  ...
  const contacts = [
    {
      ...
      description: t('contacto.methods.email'),
    ...
    },
    {
      ...
      description: t('contacto.methods.linkedin'),
    ...
    },
    {
      ...
      description: t('contacto.methods.github'),
    ...
    },
    {
      ...
      description: t('contacto.methods.whatsapp'),
